...
// DeriveDrives 从 Genome + LifeState + MentalState 派生本轮内驱力。
//
// Phase 0.2 极简公式（v1）：
//
//   social     : SocialNeed > 0.5 || Sociability > 0.7
//   knowledge  : Curiosity > 0.5 && Competence < 0.6
//   creativity : Creativity > 0.6 && Satisfaction < 0.7
//   stability  : Stress > 0.5
//   achievement: Persistence > 0.6 && active goal failed recently (Phase 0 简化为 Confidence < 0.4)
//
// 强度 = 触发条件越满足越强；0.3-1.0。
func DeriveDrives(g core.Genome, ls core.LifeState, ms core.MentalState) []core.Drive {
