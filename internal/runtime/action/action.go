...
func buildDeliberativeSystemPrompt(g *core.Goal) string {
	...
	sb.WriteString("  ⚠ 抓取优先国内可达源：菜鸟教程/掘金/CSDN/思否(segmentfault)/博客园/知乎/百度百科/官方中文文档。\n")
	sb.WriteString("    墙外站（wikipedia/medium/stackoverflow/github raw/各类 .io 博客）大概率握手超时，别浪费轮次，换国内源。\n")
